...
| **[XTRAWRKX_PRODUCTION_DEPLOYMENT_GUIDE.md](./XTRAWRKX_PRODUCTION_DEPLOYMENT_GUIDE.md)** | **Full production deploy**: Railway API + Postgres + Redis, CRM/PM data migration, new Vercel FE projects, DNS cutover | 25 min | 🔴 High |
...
| -------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[XTRAWRKX_PRODUCTION_DEPLOYMENT_GUIDE.md](./XTRAWRKX_PRODUCTION_DEPLOYMENT_GUIDE.md)**                 | End-to-end production: Railway (API/Postgres/Redis), pg_dump from working CRM/PM, new Vercel projects, `*.xtrawrkx.com` cutover                                               |
