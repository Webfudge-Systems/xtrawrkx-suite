...
import { Badge, KPICard, LoadingSpinner, Table, TableCellText, TableEmptyBelow } from '@webfudge/ui'
      ...
      <div className="space-y-3">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          {loading ? (
            ...
            <>
              <Table columns={columns} data={roleRows} keyField="id" variant="modernEmbedded" />
              {roleRows.length === 0 && (
                <TableEmptyBelow
