    ...
    class LinkedInExtractor {
        ...
        observeUrlChanges() {
            ...
            const handleUrlChange = (newUrl, reason = 'unknown') => {
                ...
                // Send a fast preliminary update immediately so the sidebar clears old data
                this.sendPageDataToSidebar();

                // Full extraction after a short settle delay
                ...
                }, 250); // Reduced from 600ms for faster profile switch
            };
            ...
            }, 300); // Check every 300ms (reduced from 500ms)
        ...
        extractProfileData() {
            ...
            if (typeof ProfileStructuredParser !== 'undefined') {
                const structured = ProfileStructuredParser.parseFromDocument(document, {
