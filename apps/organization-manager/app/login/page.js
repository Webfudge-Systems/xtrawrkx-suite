  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-primary to-orange-600 relative flex-col justify-center px-16 py-20">
        <LoginBrandCorner
          brandIconPath={ORG_MANAGER_SITE.logoPath}
          brandName={ORG_MANAGER_SITE.brandName}
        />
        <div className="max-w-lg">
          <h1 className="text-5xl font-bold text-white mb-6">{ORG_MANAGER_SITE.name}</h1>
          <p className="text-xl text-white/90 mb-4">
            Your central hub to manage all your companies — teams, access, and apps in one place.
          </p>
          <p className="text-white/80 leading-relaxed">
            Switch between organizations, invite your team, and open CRM, PM, and Accounts for each company.
          </p>
          <div className="mt-12 grid grid-cols-3 gap-6">
            {[
              { label: 'Companies', value: 'Manage' },
      ...
      {/* Mobile header — Webfudge Systems wordmark */}
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-8 lg:p-16 pt-24 lg:pt-16">
        <div className="mx-auto w-full max-w-md">
          <div className="mb-6 lg:hidden">
            <p className="font-bold text-brand-dark text-base">{ORG_MANAGER_SITE.name}</p>
            <p className="text-xs text-gray-500 mt-0.5">{ORG_MANAGER_SITE.tagline}</p>
          </div>
          <h2 className="mb-2 text-2xl font-semibold text-brand-dark sm:text-3xl">Sign in</h2>
          <p className="mb-8 text-sm text-gray-600">
            Access your companies and organizations from one account.
          </p>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <Input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@company.com" error={errors.email} className="w-full" />
