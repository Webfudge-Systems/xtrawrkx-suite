      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-primary to-orange-600 relative flex-col justify-center px-16 py-20">
        ...
        <div className="max-w-lg">
          ...
          <p className="text-xl text-white/90 mb-4">
            Create and manage organizations, teams, and platform access across the Webfudge Systems platform.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-8 lg:p-16 pt-24 lg:pt-16">
        <div className="mx-auto w-full max-w-md">
          <div className="mb-6 lg:hidden">
            <p className="font-bold text-brand-dark text-base">Platform Admin</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <Input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@webfudge.in" error={errors.email} className="w-full" />
